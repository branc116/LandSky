...
namespace LandSky.Components
{
    ...
    public abstract class Component : IEnumerable, IDisposable
    {
        ...
        public SortedDictionary<string, Component> Controls { get; set; }

        public Component(string Name)
        {
            Controls = new SortedDictionary<string, Component>();
            Rand = new Random();
            this.Name = Name;
            IsRoot = false;
        }
        ...
        public bool CheckCollision(SortedDictionary<string, Component> Components, Component NewComponent)
        {
        ...
        public async Task SaveState(string FileName)
        {
            ...
            //    try
            //    {
            //        System.IO.StringWriter.Null.Write(await GimeJSON())) { .WriteAllText(FileName, await GimeJSON(), System.Text.Encoding.UTF8); }
            //        System.IO.Path.
            //    }
            //    catch
            //    {
        ...
        public static Task<Component> GimeComponentFromJSON(string FileName)
        {
